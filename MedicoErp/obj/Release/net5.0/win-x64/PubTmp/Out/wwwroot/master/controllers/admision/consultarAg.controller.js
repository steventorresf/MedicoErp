(function () {
    ...
    AppController.$inject = ['$location', '$scope', '$cookies', 'UsuarioService', 'CitaService'];
    ...
    function AppController($location, $scope, $cookies, usuService, citService) {
        ...
        function consultarAg() {
            ...
            vm.data = {
                fechaInicio: vm.entity.fechaInicio.DateErp(true),
                fechaFin: vm.entity.fechaFin.DateErp(true),
        ...
        function descargarExcel() {
            window.location.href = url + 'Excel/AgendaMedica?Fi=' + vm.data.fechaInicio + '&Ff=' + vm.data.fechaFin + '&Im=' + vm.data.idMedico + '&Nm=' + vm.data.medico;
        }
    }
})();
