(function () {
    ...
    AppController.$inject = ['$location', '$scope', '$cookies', 'PacienteService', 'ConvenioService', 'ConvenioServicioService', 'UsuarioService', 'TablaDetalleService', 'CitaService', 'FacturacionService', 'HorarioService', 'DepartamentoService', 'MunicipioService'];
    ...
    function AppController($location, $scope, $cookies, pacService, conService, serconService, usuService, tabdetService, citService, factService, horService, depService, munService) {
        ...
        function asignCita(entity) {
            ...
            vm.entityCit.idCentroRemision = vm.userApp.idCentro;
        ...
        vm.gridOptions = {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    enableCellEdit: false,
                    cellTemplate:
                        "<span><a href='' ng-click='grid.appScope.vm.imprimirCita(row.entity.idCita)' tooltip='Imprimir' tooltip-trigger='mouseenter' tooltip-placeholder='top'>" +
        ...
        function facturarCit() {
            vm.entityFact = {
                idCentro: vm.userApp.idCentro,
                idCentroRemision: vm.userApp.idCentro,
        ...
        function imprimirCita(idCita) {
            ...
            citService.imprimirCita(vm.idCita);
        }
