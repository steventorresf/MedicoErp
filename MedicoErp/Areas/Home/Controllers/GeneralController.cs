...
namespace MedicoErp.Areas.Home.Controllers
{
    ...
    public class GeneralController : ControllerBase
    {
        ...
        public IActionResult InicioSesion([FromBody] JObject data)
        {
            ...
            {
                ErroresBusiness.Create("InicioSesion", ex.Message, null);
                throw;
            }
        }
        ...
        public IActionResult GetCookies()
        {
            try
            {
                if (Util.ValidarUsu(HttpContext))
                {
                ...
                else { return Ok(new { resp = true, esValido = false }); }
            }
            catch (Exception ex)
            {
                ErroresBusiness.Create("GetCookies", ex.Message, null);
        ...
        public IActionResult CierreSesion([FromBody] JObject data)
        {
            ...
            {
                ErroresBusiness.Create("CierreSesion", ex.Message, null);
                return Ok(new { resp = false });
            }
        }
