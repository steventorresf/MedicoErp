(function () {
    ...
    AppController.$inject = ['$location', '$scope', '$cookies', 'AdminServiciosService', 'AdminEspecialidadesService', 'AdminClasesServiciosService'];

    function AppController($location, $scope, $cookies, serService, espService, cserService) {
        var vm = this;
        ...
        function getEspecialidades() {
            var response = espService.getAll();
            response.then(
                function (response) {
                    vm.listEspecialidades = response.data;
                },
                function (response) {
                    console.log(response);
                }
        ...
        vm.gridOptions = {
            ...
            columnDefs: [
                ...
                {
                    name: 'especialidad.nombreEspecialidad',
                    field: 'especialidad.nombreEspecialidad',
                    displayName: 'Especialidad',
                    headerCellClass: 'bg-header',
                    width: 300,
                },
                {
                    name: 'claseServicio.claseServicio',
                    field: 'claseServicio.claseServicio',
