(function () {
    ...
    AppController.$inject = ['$location', '$scope', '$cookies', 'AdminPacientesService', 'HistClinicaEventosService', 'HistClinicaFormulacionesService', 'HistClinicaOrdenesService', 'HistClinicaMultimediaService', 'GenTablasDetalleService'];

    function AppController($location, $scope, $cookies, pacService, eveService, forService, ordService, mulService, tabdetService) {
        var vm = this;
        ...
        function imprimirEvento(entity) {
            eveService.imprimirEvento(entity.idEvento);
        }
